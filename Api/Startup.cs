...
public class Startup
{
    public Startup(IConfiguration configuration)
    {
        if(configuration != null){
            ...
            key = builder.Configuration.GetSection("Jwt").ToString();
        }
    }
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseEndPoints(endpoints =>
        {
            ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO)
            {
                ...
                {
                    mensagens.Mensagem.Add("O nome não pode ser vazio");
                }

                if (string.IsNullOrEmpty(veiculoDTO.Marca))
                {
                    mensagens.Mensagem.Add("A marca não pode ficar em branco");
                }
                if (veiculoDTO.Ano < 1950)
                {
                    mensagens.Mensagem.Add("Veiculo muito antigo, aceito somente anos superiores");
                }
                return mensagens; 
            }
            ...
            endpoints.MapDelete("/veiculos/{id}", ([FromRoute] int id, VeiculoDTO veiculoDTO, IVeiculoServico veiculoServico) => {
                var veiculo = veiculoServico.BuscaPorId(id);
                if(veiculo == null) return Results.NotFound();
            ...
            endpoints.MapGet("/adms", ([FromQuery] int? pagina, IAdministradorServico administradorServico) =>
            {
            ...
            endpoints.MapPost("/administradores", ([FromBody] AdministradorDTO administradorDTO, IAdministradorServico administradorServico) =>
            {
                ...
                return Results.Created($"/administrador/{administrador.Email}", new AdministradorModelView
                {
                    Id = administrador.ID,
